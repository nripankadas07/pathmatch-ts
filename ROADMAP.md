...
`pathmatch-ts`: Typed glob/path matcher with brace expansion, globstar, character classes, case-insensitive and dot-file modes, and a pre-compilable PathMatcher..
